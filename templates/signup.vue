    ...
    <div class="menufix"> <a class="logo" href="index.html"><img src="images/logo.jpg" alt="Hello"></a>
      ...
      <nav>
        <ul>
            ...
            <li><a class="out animsition-link" href="login.jsp">SIGN IN</a></li>
            <li class="line"><a class="out animsition-link" href="signup.html">SIGNUP</a></li>
        </ul>
      </nav>
    </div>
    </header>
        ...
        <div class="slickwrap">
          ...
          <form method="post"  action="register">
            <fieldset>
              ...
              <input id="name" name="name" class="name" type="text" value="" onblur="isname(this.value)" id="username" required="">
              <br />
              <label><span>*</span>User Type</label>
              <input id="email" name="utype" class="utype" type="text" value="">
              <br />
              <label><span>*</span>Email</label>
              <input id="email" name="email" class="email" type="email" value="" onblur="ismail(this.value)" id="mailid" required="">
              <br />
              ...
              <input id="email" name="city" type="text" value="" onblur="iscity(this.value)" id="textfield5" required="">
              <br />
              <label><span>*</span>Phone</label>
              <input id="phone" name="phone" type="number" value="" maxlength="10" onblur="ismobile(this.value)" id="mobile" required="">
              <br />
              <label><span>*</span>Password</label>
              <input id="email" name="psw" type="password" value="" onblur="ispass(this.value)" id="password1" required="">
              <br />
