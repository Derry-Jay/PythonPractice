      ...
      <div class="grid flex">
        <div class="row">
          <div class="colw_6">
            ...
            <h2 id="title-sub2">Association Rule</h2>
          </div>
          <div class="colw_6 wow zoomIn">
            <div class="box-fix">
              <h3 class="centered">Find your Disease on Ontology</h3>
        ...
        <div class="row">
          <div class="colw_6 beta wow column zoomIn">
            <div class="wrapimg hack960">
              <div class="pic"> <img src="images/1.jpg" class="pic-image full-width" alt="Pic"/>
                <div class="pic-caption top-to-bottom">
                  <h4 class="pic-title">GENE ONTOLOGY</h4>
                </div>
              </div>
            </div>
          </div>
          <div class="colw_6 beta column reladiv">
             <h1 style="margin-left: 200px">GENE lIST</h1>
             <table style="margin-left: 100px;width: 400px;background-color: darkgray;padding: 20px">
                 <tr><td><strong>Serial No</strong></td><td><strong>Gene Name</strong></td><td><strong>Gene ID</strong></td></tr>
                 <tr><td>{{j}}</td><td>{{th}}</td>
...
<script type="text/javascript" src="{{ url_for('static',filename='js/jquery.matchHeight-min.js') }}"></script>
<script src="{{ url_for('static',filename='') }}js/wow.min.js"></script>
<script src="{{ url_for('static',filename='js/animsition.min.js') }}"></script>
<script src="{{ url_for('static',filename='js/lightgallery-all.min.js') }}"></script>
...
<style src="{{ url_for('static',filename='css/social.css') }}"></style>
