        ...
        <div class="row">
          ...
          <div class="colw_6 beta column reladiv">
             ...
             <table style="margin-left: 100px;width: 400px;background-color: darkgray;padding: 20px">
                 <tr><td><strong>Gene Name</strong></td><td><strong>Gene ID</strong></td><td><strong>CATEGORY</strong></td></tr>
                 <form method="post" action="go1.jsp">
                     <input type="text" name="gid" value="<%=gid%>" hidden="">
                     <tr><td><%=gn%></td><td><%=gid%></td><td><input type="submit" value="Category"></td></tr>
                 </form>
               </table>
             </div>
           </div>
