  ...
  var l = {
    ...
    loadContent: function () {
      function a (a) {
        var d,
          e = ''
        if (typeof b.options.jsonSuccess === 'function') { b.options.jsonSuccess.apply(this, [a]) } else {
      ...
      var b = this,
        e
      typeof b.options.beforeInit === 'function' &&
        b.options.beforeInit.apply(this, [b.$elem])
      typeof b.options.jsonPath === 'string'
    ...
    setVars: function () {
      if (this.$elem.children().length === 0) return !1
      this.baseClass()
      this.eventTypes()
    ...
    updateVars: function () {
      typeof this.options.beforeUpdate === 'function' &&
      ...
      this.updateControls()
      this.eachMoveUpdate()
      typeof this.options.afterUpdate === 'function' &&
    ...
    appendItemsSizes: function () {
      ...
      a.$owlItems.each(function (c) {
        ...
        if (c % a.options.items === 0 || c === e) c > e || (b += 1)
    ...
    next: function (a) {
      ...
      if (
        ...
        if (!0 === this.options.rewindNav) { (this.currentItem = 0), (a = 'rewind') } else return (this.currentItem = this.maximumItem), !1
      }
    ...
    prev: function (a) {
      ...
      if (this.currentItem < 0) {
        if (!0 === this.options.rewindNav) { (this.currentItem = this.maximumItem), (a = 'rewind') } else return (this.currentItem = 0), !1
      }
      this.goTo(this.currentItem, a)
    },
    goTo: function (a, b, e) {
      ...
      typeof c.options.beforeMove === 'function' &&
        c.options.beforeMove.apply(this, [c.$elem])
      a >= c.maximumItem ? (a = c.maximumItem) : a <= 0 && (a = 0)
    ...
    jumpTo: function (a) {
      typeof this.options.beforeMove === 'function' &&
        this.options.beforeMove.apply(this, [this.$elem])
      a >= this.maximumItem || a === -1
        ? (a = this.maximumItem)
        : a <= 0 && (a = 0)
      this.swapSpeed(0)
    ...
    swapSpeed: function (a) {
      a === 'slideSpeed'
        ...
        : a === 'paginationSpeed'
          ...
          : typeof a !== 'string' && this.$owlWrapper.css(this.addCssSpeed(a))
    },
    ...
    gestures: function () {
      ...
      function e (b) {
        ...
        typeof d.options.startDragging === 'function' &&
          !0 !== h.dragging &&
          d.newRelativeX !== 0 &&
    ...
    getNewPosition: function () {
      ...
      a > this.maximumItem
        ...
        : this.newPosX >= 0 && (this.currentItem = a = 0)
      return a
    },
    ...
    lazyPreload: function (a, b) {
      function e () {
        ...
        d.options.lazyEffect === 'fade' ? b.fadeIn(400) : b.show()
        typeof d.options.afterLazyLoad === 'function' &&
    ...
    completeImg: function (a) {
      return !a.complete ||
        (typeof a.naturalWidth !== 'undefined' && a.naturalWidth === 0)
        ? !1
        : !0
    },
    ...
    addItem: function (a, b) {
      var e
      if (!a) return !1
      if (this.$elem.children().length === 0) { return this.$elem.append(a), this.setVars(), !1 }
      this.unWrap()
      e = void 0 === b || b === -1 ? -1 : b
      e >= this.$userItems.length || e === -1
