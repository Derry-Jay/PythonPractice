<script type = "text/javascript"></script>
    ...
    <meta
      property="og:title"
      content="Free responsive web template Istria - Contact"
    />
    <meta
      property="og:description"
      content="Free responsive web template Istria by Valeron design studio - Contact"
    />
    <meta
      property="og:image"
    ...
    <link
      ...
      sizes="57x57"
      href="{{ url_for('static',filename='img/apple-touch-icon-57x57.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="60x60"
      href="{{ url_for('static',filename='img/apple-touch-icon-60x60.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="72x72"
      href="{{ url_for('static',filename='img/apple-touch-icon-72x72.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="76x76"
      href="{{ url_for('static',filename='img/apple-touch-icon-76x76.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="114x114"
      href="{{ url_for('static',filename='img/apple-touch-icon-114x114.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="120x120"
      href="{{ url_for('static',filename='img/apple-touch-icon-120x120.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="144x144"
      href="{{ url_for('static',filename='img/apple-touch-icon-144x144.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="152x152"
      href="{{ url_for('static',filename='img/apple-touch-icon-152x152.png') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="180x180"
      href="{{ url_for('static',filename='img/apple-touch-icon-180x180.png') }}"
    />
    <link
      rel="icon"
      type="image/png"
    ...
    <link
      rel="icon"
      type="image/png"
      href="{{ url_for('static',filename='img/favicon-96x96.png') }}"
      sizes="96x96"
    />
    <link
      rel="icon"
    ...
    <link rel="stylesheet" type="text/css" href="{{ url_for('static',filename='css/animsition.min.css') }}">
    <!-- 
    <link>
    ...
    <!-- 
    <style src="{{ url_for('static',filename='css/slickform.css') }}"></style> -->
    ...
    <style src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome-animation/0.0.8/font-awesome-animation.min.css"></style>
    ...
    <script src="{{ url_for('static',filename='js/Slickform.js') }}"></script>
      ...
      <header class="main_h">
        <div class="menufix">
          ...
          <nav>
            <ul>
              <li class="line">
                <a class="out animsition-link" href="index.html">HOME</a>
              </li>
              <li>
                <a class="out animsition-link" href="login.jsp">SIGN IN</a>
              </li>
              <li class="line">
                <a class="out animsition-link" href="signup.html">SIGNUP</a>
              </li>
            </ul>
          </nav>
        </div>
    ...
    <div class="grid">
      <div class="row paddtop100">
        <div class="colw_6 spec-l-cont border-right">
          <h3>GENE INFO</h3>
          <a><img src="img/gen.png" alt="Google Maps" class="full-width" /></a>
        </div>
...
function rate(str, str1, str2) {
  ...
  xmlhttp.open(
    "GET",
    "rate.jsp?dit=" + str + "&d=" + str1 + "&&str2=" + str2,
    true
  );
  xmlhttp.send();
}
