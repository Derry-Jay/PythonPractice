...
insert  into `ghis`(`sid`,`uid`,`gid`,`gtype`) values (1,'kahi','2629','extrinsic'),(2,'kahi','5580','intrinsic'),(3,'anagan','2629','extrinsic'),(4,'anagan','2629','intrinsic');
...
insert  into `reg`(`username`,`password`,`mail`,`mobile`,`gender`,`addr`) values ('anagan','123','kahilanmuthu5@gmail.com','1234567890','male','nellai'),('kahi','123','kahilanmuthu5@gmail.com','1231231233','male','nellai\r\n');
