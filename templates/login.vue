...
<div class="animsition-overlay">
  <div id="section-1">
      ...
      <div class="menufix"> <a class="logo" href="index.html"><img src="images/logo.png" alt="Hello"></a>
        ...
        <nav>
          <ul>
            ...
            <li ><a class="out active animsition-link" href="login.jsp">SIGNIN</a></li>
    ...
    <div class="hero">
      <div class="main-wrap" style="height: -10px">
        <form method="post" action="login">
            <div class="login-main">
                <input type="text" placeholder="User name" name="uname" class="box1 border1">
                <input type="password" placeholder="password" name="psw" class="box1 border2">
