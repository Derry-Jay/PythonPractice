        ...
        <div class="menufix"> <a class="logo" href="index.html"><img src="images/logo.png" alt="Hello"></a>
          ...
          <nav>
            <ul>
              ...
              <li class="line"><a class="out animsition-link" href="login.jsp">LOGOUT</a></li></ul>
            </ul>
          </nav>
        </div>
      </header>
      <div class="grid flex">
        <div class="row">
          <div class="colw_6">
            ...
            <h2 id="title-sub2">Disease Category</h2>
          </div>
        ...
        <div class="row">
          ...
          <div class="colw_6 beta column reladiv">
             <h1 style="margin-left: 200px">GENE CATEGORY</h1>
             <table style="margin-left: 100px;width: 400px;background-color: darkgray;padding: 20px">
                <tr><td><strong>S.No</strong></td><td><strong>Disease Category</strong></td><td><strong>Count</strong></td></tr>
                <form method="post" action="dis1.jsp">
                    <input type="text" name="gid" value="<%=cat%>" hidden="">
                    <tr><td><%=sn%></td><td><input type="submit"value="<%=cat%>"></td><td><%=count%></td></tr>
                </form>
             </table>
          </div>
        </div>
