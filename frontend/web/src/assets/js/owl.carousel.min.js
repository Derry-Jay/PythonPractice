...
(function (f, g, k) {
  var l = {init: function (a, b) { this.$elem = f(b); this.options = f.extend({}, f.fn.owlCarousel.options, this.$elem.data(), a); this.userOptions = a; this.loadContent() },
    loadContent: function () {
      function a (a) { var d, e = ''; if (typeof b.options.jsonSuccess === 'function')b.options.jsonSuccess.apply(this, [a]); else { for (d in a.owl)a.owl.hasOwnProperty(d) && (e += a.owl[d].item); b.$elem.html(e) }b.logIn() } var b = this, e; typeof b.options.beforeInit === 'function' && b.options.beforeInit.apply(this, [b.$elem]); typeof b.options.jsonPath === 'string'
...
(this.options.autoPlay = 5E3); this.play(); this.$elem.find('.owl-wrapper').css('display', 'block'); this.$elem.is(':visible') ? this.$elem.css('opacity', 1) : this.watchVisibility(); this.onstartup = !1; this.eachMoveUpdate(); typeof this.options.afterInit === 'function' && this.options.afterInit.apply(this, [this.$elem])
    ...
    baseClass: function () { var a = this.$elem.hasClass(this.options.baseClass), b = this.$elem.hasClass(this.options.theme); a || this.$elem.addClass(this.options.baseClass); b || this.$elem.addClass(this.options.theme) },
...
!0 === this.options.itemsScaleUp && (this.options.items = this.itemsAmount)
    ...
    response: function () { var a = this, b, e; if (!0 !== a.options.responsive) return !1; e = f(g).width(); a.resizer = function () { f(g).width() !== e && (!1 !== a.options.autoPlay && g.clearInterval(a.autoPlayInterval), g.clearTimeout(b), b = g.setTimeout(function () { e = f(g).width(); a.updateVars() }, a.options.responsiveRefreshRate)) }; f(g).resize(a.resizer) },
    updatePosition: function () { this.jumpTo(this.currentItem); !1 !== this.options.autoPlay && this.checkAp() },
    appendItemsSizes: function () {
      var a =
this, b = 0, e = a.itemsAmount - a.options.items; a.$owlItems.each(function (c) { var d = f(this); d.css({width: a.itemWidth}).data('owl-item', Number(c)); if (c % a.options.items === 0 || c === e)c > e || (b += 1); d.data('owl-roundPages', b) })
    },
...
this.options.items)
    ...
    loops: function () {
      var a = 0, b = 0, e, c; this.positionsInArray = [0]; this.pagesInArray = []; for (e = 0; e < this.itemsAmount; e += 1) {
...
this.owl.currentItem = a; this.afterGo()
    ...
    doTranslate: function (a) {
      return {'-webkit-transform': 'translate3d(' + a + 'px, 0px, 0px)',
...
a = 0); return a
    ...
    lazyPreload: function (a, b) {
      function e () {
        a.data('owl-loaded', 'loaded').removeClass('loading'); b.removeAttr('data-src'); d.options.lazyEffect === 'fade' ? b.fadeIn(400) : b.show(); typeof d.options.afterLazyLoad === 'function' && d.options.afterLazyLoad.apply(this,
          [d.$elem])
      } function c () { f += 1; d.completeImg(b.get(0)) || !0 === k ? e() : f <= 100 ? g.setTimeout(c, 100) : e() } var d = this, f = 0, k; b.prop('tagName') === 'DIV' ? (b.css('background-image', 'url(' + b.data('src') + ')'), k = !0) : b[0].src = b.data('src'); c()
    },
    autoHeight: function () {
    ...
    singleItemTransition: function () {
      var a = this, b = a.outClass, e = a.inClass, c = a.$owlItems.eq(a.currentItem), d = a.$owlItems.eq(a.prevItem), f = Math.abs(a.positionsInArray[a.currentItem]) + a.positionsInArray[a.prevItem], g = Math.abs(a.positionsInArray[a.currentItem]) + a.itemWidth / 2; a.isTransition = !0; a.$owlWrapper.addClass('owl-origin').css({'-webkit-transform-origin': g + 'px',
        '-moz-perspective-origin': g +
'px',
        'perspective-origin': g + 'px'}); d.css({position: 'relative', left: f + 'px'}).addClass(b).on('webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend', function () { a.endPrev = !0; d.off('webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend'); a.clearTransStyle(d, b) }); c.addClass(e).on('webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend', function () { a.endCurrent = !0; c.off('webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend'); a.clearTransStyle(c, e) })
    },
    ...
    removeItem: function (a) { if (this.$elem.children().length === 0) return !1; a = void 0 === a || a === -1 ? -1 : a; this.unWrap(); this.$userItems.eq(a).remove(); this.setVars() }}; f.fn.owlCarousel = function (a) {
    return this.each(function () {
      if (!0 ===
f(this).data('owl-init')) return !1; f(this).data('owl-init', !0); var b = Object.create(l); b.init(a, this); f.data(this, 'owlCarousel', b)
    })
  }; f.fn.owlCarousel.options = {items: 5,
    itemsCustom: !1,
    itemsDesktop: [1199, 4],
